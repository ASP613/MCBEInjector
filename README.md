...
The goal is to be efficient, and I am satisfied that this project is reasonably so; the binary should run on most Windows installations, does not require the C Runtime Library, and is 5248 bytes in size. 
